...
mod tests {
    ...
    fn test_mse() {
        ...
        let loss = mse_loss(x.trace_all(), y);
    ...
    fn test_mae() {
        ...
        let loss = mae_loss(x.trace_all(), y);
    ...
    fn test_soft_cross_entropy() {
        ...
        let loss = cross_entropy_with_logits_loss(x.trace_all(), y.clone());
    ...
    fn test_kl_div() {
        ...
        let loss = kl_div_with_logits_loss(logits.trace_all(), targ);
    ...
    fn test_bce() {
        ...
        let loss = binary_cross_entropy_with_logits_loss(logit.trace_all(), prob.clone());
    ...
    fn test_bce_wide_range() {
        ...
        let loss = binary_cross_entropy_with_logits_loss(logit.trace_all(), targ.clone());
    ...
    fn test_huber_loss() {
        ...
        let loss = huber_loss(x.trace_all(), y.clone(), 0.5);
    ...
    fn test_smooth_l1_loss() {
        ...
        let loss = smooth_l1_loss(x.trace_all(), y.clone(), 0.5);
