...
mod tests {
    ...
    fn test_conv2d_default_stride_and_padding() {
        ...
        assert_aclose!(g.get(&bias), [0.82979727, 0.36021793]);
    }
    ...
    fn test_conv2d_stride_2() {
        ...
        let result = x.leaky_trace().conv2d::<2, 0>(weight.clone())
            + bias.leaky_trace().broadcast::<_, Axes2<1, 2>>();
        assert_aclose!(result, [[[-0.29368058]], [[0.30018353]]]);
        ...
        assert_aclose!(g.get(&bias), [0.37275729, 0.67505330]);
    }
    ...
    fn test_conv2d_padding_1() {
        ...
        assert_aclose!(g.get(&bias), [0.28636602, 0.44933242, 0.40484178]);
    }
    ...
    fn test_conv2d_stride_3_padding_4() {
        ...
        assert_aclose!(g.get(&bias), [0.44699076, 0.408709]);
    }
