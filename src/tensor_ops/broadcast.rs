...
// 0d -> Nd
impl_broadcast!(Tensor0D<H>, Axis<0>, Tensor1D<M, H>, {M});
...
// 2d -> Nd
impl_broadcast!(Tensor2D<M, N, H>, Axis<2>, Tensor3D<M, N, O, H>, {M, N, O});
...
// 3d -> 4d
impl_broadcast!(Tensor3D<M, N, O, H>, Axis<3>, Tensor4D<M, N, O, P, H>, {M, N, O, P});
