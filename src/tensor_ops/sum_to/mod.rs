...
mod tests {
    ...
    fn test_sum_axis_0_2d() {
        ...
        let r = t.trace_all().sum::<Rank1<3>, _>();
        let e = [-1.0, 6.0, -3.0];
        assert_eq!(r.array(), e);
    ...
    fn test_sum_axis_1_2d() {
        let dev: TestDevice = Default::default();
        let t: Tensor<_, TestDtype, _> = dev.tensor([[1.0, 2.0, 3.0], [-2.0, 4.0, -6.0]]);
        let r = t.trace_all().sum::<Rank1<2>, _>();
        let e = [6.0, -4.0];
        assert_eq!(r.array(), e);
        let g = r.exp().mean().backward();
        assert_close(
    ...
    fn test_sum_axes_3d_to_1d() {
        ...
        let r = t.trace_all().sum::<Rank1<3>, _>();
        let r2 = t.trace_all().sum::<Rank2<3, 4>, _>().sum::<Rank1<3>, _>();
    ...
    fn test_sum_broadcasted() {
        ...
        let r1 = t1.trace_all().sum::<Rank1<4>, _>() * 5.0;
        let r2 = t2.trace_all().sum::<Rank1<4>, _>();
    ...
    fn test_sum_chunking() {
        ...
        let r = t.trace_all().sum::<Rank1<60>, _>();
    ...
    fn test_sum_reduce_to_0d_from_broadcasted() {
        ...
        let b = a.trace_all().broadcast::<Rank3<4, 3, 2>, _>();
        let c = b.sum();
