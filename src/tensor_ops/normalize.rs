...
mod tests {
    ...
    fn test_1d_normalize_axis_last() {
        ...
        let r = a.leaking_trace().normalize(1e-5);
    ...
    fn test_2d_normalize_axis_last() {
        ...
        let r = a.leaking_trace().normalize::<Axis<1>>(1e-5);
        assert_close(
            &r.array(),
            &[
    ...
    fn test_2d_normalize_axis_first() {
        ...
        let r = a.leaking_trace().normalize::<Axis<0>>(1e-5);
        assert_close(
            &r.array(),
            &[
                [-1.2247438, -1.1355485],
    ...
    fn test_3d_normalize_axis_last() {
        ...
        let r = a.leaking_trace().normalize::<Axis<2>>(1e-5);
