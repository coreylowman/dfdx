...
torch.manual_seed(0)
test_data = {
    "default": gen_data((7, 3, 15, 15), (5, 3, 4, 4), 1, 0, 1, 1),
    "s2": gen_data((7, 3, 15, 15), (5, 3, 4, 4), 2, 0, 1, 1),
    "p1": gen_data((7, 3, 15, 15), (5, 3, 4, 4), 1, 1, 1, 1),
    "d2": gen_data((7, 3, 15, 15), (5, 3, 4, 4), 1, 0, 2, 1),
    "g2": gen_data((7, 6, 15, 15), (6, 3, 4, 4), 1, 0, 1, 2),
    "g3": gen_data((7, 18, 15, 15), (9, 6, 4, 4), 1, 0, 1, 3),
    "all": gen_data((7, 9, 15, 15), (6, 3, 4, 4), 2, 1, 2, 3),
}
