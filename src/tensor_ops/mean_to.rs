...
mod tests {
    ...
    fn test_mean_1d() {
        ...
        assert_aclose!(&g.get(&t), &[2.463019; 3]);
    }
    ...
    fn test_mean_2d() {
        ...
        assert_aclose!(r, 3.5);
        let g = r.backward();
        assert_aclose!(g.get(&t), [[1.0 / 6.0; 3]; 2]);
    }
    ...
    fn test_mean_3d() {
        ...
        assert_aclose!(r, 1.0);
        let g = r.backward();
        assert_aclose!(g.get(&t), [[[1.0 / 24.0; 3]; 2]; 4]);
    }
    ...
    fn test_mean_axis_0_2d() {
        ...
        assert_aclose!(r, [-0.5, 3.0, -1.5]);
        let g = r.exp().mean().backward();
        assert_aclose!(g.get(&t), [[0.10108845, 3.3475895, 0.037188362]; 2]);
    }
    ...
    fn test_mean_axis_1_2d() {
        ...
        assert_aclose!(r, [2.0, -4.0 / 3.0]);
        let g = r.exp().mean().backward();
        assert_aclose!(g.get(&t), [[1.2315094; 3], [0.043932855; 3]]);
    }
    ...
    fn test_mean_axes_3d_to_1d_02() {
        ...
        assert_aclose!(&g.get(&t), &[[[1. / 24.; 4]; 3]; 2]);
