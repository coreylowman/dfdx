...
mod tests {
    ...
    fn test_add_into_2() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank1<2>>().traced_all(),
            dev.zeros::<Rank1<3>>().traced_all(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().traced_all(),
            dev.zeros::<Rank2<3, 3>>().traced_all(),
        ));
    }
    ...
    fn test_add_into_3() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank1<2>>().traced_all(),
            dev.zeros::<Rank1<3>>().traced_all(),
            dev.zeros::<Rank1<4>>().traced_all(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().traced_all(),
            dev.zeros::<Rank2<3, 3>>().traced_all(),
            dev.zeros::<Rank2<3, 4>>().traced_all(),
        ));
    }
    ...
    fn test_add_into_4() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            ...
            dev.zeros::<Rank1<3>>().traced_all(),
            dev.zeros::<Rank1<4>>().traced_all(),
            dev.zeros::<Rank1<5>>().traced_all(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().traced_all(),
            dev.zeros::<Rank2<3, 3>>().traced_all(),
            dev.zeros::<Rank2<3, 4>>().traced_all(),
            dev.zeros::<Rank2<3, 5>>().traced_all(),
        ));
    }
    ...
    fn test_add_into_5() {
        ...
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            ...
            dev.zeros::<Rank2<3, 4>>().traced_all(),
            dev.zeros::<Rank2<3, 5>>().traced_all(),
            dev.zeros::<Rank2<3, 6>>().traced_all(),
        ));
    }
    ...
    fn test_add_into_6() {
        ...
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            ...
            dev.zeros::<Rank2<3, 5>>().traced_all(),
            dev.zeros::<Rank2<3, 6>>().traced_all(),
            dev.zeros::<Rank2<3, 7>>().traced_all(),
        ));
    }
    ...
    fn longer_network() {
        ...
        let _: Tensor<Rank2<5, 1>, _, _, OwnedTape<_, _>> = model.forward((
            dev.zeros::<Rank2<5, 5>>().traced_all(),
            dev.zeros::<Rank2<5, 5>>().traced_all(),
        ));
