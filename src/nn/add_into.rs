...
mod tests {
    ...
    fn test_add_into_2() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank1<2>>().leaking_traced(),
            dev.zeros::<Rank1<3>>().leaking_traced(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().leaking_traced(),
            dev.zeros::<Rank2<3, 3>>().leaking_traced(),
        ));
    }
    ...
    fn test_add_into_3() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank1<2>>().leaking_traced(),
            dev.zeros::<Rank1<3>>().leaking_traced(),
            dev.zeros::<Rank1<4>>().leaking_traced(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().leaking_traced(),
            dev.zeros::<Rank2<3, 3>>().leaking_traced(),
            dev.zeros::<Rank2<3, 4>>().leaking_traced(),
        ));
    }
    ...
    fn test_add_into_4() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            ...
            dev.zeros::<Rank1<3>>().leaking_traced(),
            dev.zeros::<Rank1<4>>().leaking_traced(),
            dev.zeros::<Rank1<5>>().leaking_traced(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().leaking_traced(),
            dev.zeros::<Rank2<3, 3>>().leaking_traced(),
            dev.zeros::<Rank2<3, 4>>().leaking_traced(),
            dev.zeros::<Rank2<3, 5>>().leaking_traced(),
        ));
    }
    ...
    fn test_add_into_5() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            ...
            dev.zeros::<Rank1<4>>().leaking_traced(),
            dev.zeros::<Rank1<5>>().leaking_traced(),
            dev.zeros::<Rank1<6>>().leaking_traced(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().leaking_traced(),
            dev.zeros::<Rank2<3, 3>>().leaking_traced(),
            dev.zeros::<Rank2<3, 4>>().leaking_traced(),
            dev.zeros::<Rank2<3, 5>>().leaking_traced(),
            dev.zeros::<Rank2<3, 6>>().leaking_traced(),
        ));
    }
    ...
    fn test_add_into_6() {
        ...
        let _: Tensor<Rank1<5>, _, _, OwnedTape<_, _>> = m.forward((
            ...
            dev.zeros::<Rank1<5>>().leaking_traced(),
            dev.zeros::<Rank1<6>>().leaking_traced(),
            dev.zeros::<Rank1<7>>().leaking_traced(),
        ));
        let _: Tensor<Rank2<3, 5>, _, _, OwnedTape<_, _>> = m.forward((
            dev.zeros::<Rank2<3, 2>>().leaking_traced(),
            dev.zeros::<Rank2<3, 3>>().leaking_traced(),
            ...
            dev.zeros::<Rank2<3, 5>>().leaking_traced(),
            dev.zeros::<Rank2<3, 6>>().leaking_traced(),
            dev.zeros::<Rank2<3, 7>>().leaking_traced(),
        ));
    }
    ...
    fn longer_network() {
        ...
        let _: Tensor<Rank2<5, 1>, _, _, OwnedTape<_, _>> = model.forward((
            dev.zeros::<Rank2<5, 5>>().leaking_traced(),
            dev.zeros::<Rank2<5, 5>>().leaking_traced(),
        ));
