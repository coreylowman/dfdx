...
// #[test]
// fn test_mha_single_kk() {
//     const E_DIM: usize = 4;
//     const K_DIM: usize = 6;
//     const V_DIM: usize = 8;
//     const NUM_HEADS: usize = 2;
//     let mut model: MultiHeadAttention<E_DIM, E_DIM, K_DIM, V_DIM, NUM_HEADS> = Default::default();

//     let mut rng = StdRng::seed_from_u64(0);
//     model.reset_params(&mut rng);

//     model.w_q.save("w_q.npz");
//     model.w_k.save("w_k.npz");
//     model.w_v.save("w_v.npz");
//     model.w_o.save("w_o.npz");

//     let x: Tensor2D<3, 4> = TensorCreator::randn(&mut rng); // Sequence of 2 token vectors with 8 dims each
//     numpy::save("x.npy", x.data());
//     let y: Tensor2D<3, 4> = model.forward(x);
//     numpy::save("y.npy", y.data());
//     assert!(false);
// }

#[test]
fn test_mha_single_ke() {}

#[test]
fn test_mha_batch_kk() {}

#[test]
fn test_mha_batch_ke() {}
