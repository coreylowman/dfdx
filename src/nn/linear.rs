...
mod tests {
    ...
    fn test_forward_1d() {
        ...
        assert_aclose!(y, [-0.93430865, 0.08624211]);
        ...
        assert_aclose!(g.get(&model.bias), [-0.93430865, 0.08624211]);
    }
    ...
    fn test_forward_2d() {
        ...
        assert_aclose!(g.get(&model.bias), [0.7679174, -0.31687993]);
    }
    ...
    fn test_forward_3d() {
        ...
        assert_aclose!(g.get(&model.bias), [0.40265593, -0.2874091]);
    }
}
