...
pub trait ZerosTensor<E: Dtype>: DeviceStorage {
    ...
    /// # use dfdx::prelude::*;
    /// # let dev: Cpu = Default::default();
    /// let a: Tensor<(Dyn, Const<3>)> = dev.zeros_like(&(Dyn(5), Const::<3>));
    /// ```
    ///
...
pub trait OnesTensor<E: Dtype>: DeviceStorage {
    ...
    /// # use dfdx::prelude::*;
    /// # let dev: Cpu = Default::default();
    /// let a: Tensor<(Dyn, Const<3>)> = dev.ones_like(&(Dyn(5), Const::<3>));
    /// ```
    ///
    /// Given another tensor:
    /// ```rust
...
pub trait RandTensor<E: Dtype>: DeviceStorage {
    ...
    /// # use dfdx::prelude::*;
    /// # let dev: Cpu = Default::default();
    /// let a: Tensor<(Dyn, Const<3>)> = dev.rand_like(&(Dyn(5), Const::<3>));
    /// ```
    ///
    /// Given another tensor:
    /// ```rust
...
pub trait RandnTensor<E: Dtype>: DeviceStorage {
    ...
    /// # use dfdx::prelude::*;
    /// # let dev: Cpu = Default::default();
    /// let a: Tensor<(Dyn, Const<3>)> = dev.randn_like(&(Dyn(5), Const::<3>));
    /// ```
    ///
    /// Given another tensor:
    /// ```rust
